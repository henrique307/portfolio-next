...
export function Trabalhos() {
  ...
  return (
    <section
      id="trabalhos"
      className={`pb-32 pt-20 bg-base-100 w-full flex justify-center ${!open ? "max-h-[2400px] md:max-h-[1000px] xl:max-h-[800px]" : "max-h-fit"} overflow-hidden relative transition-all duration-1000 text-base-content`}
    >
